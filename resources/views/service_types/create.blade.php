<x-app-layout>
    <x-slot name="header">
        <div style="display:flex;align-items:center;gap:10px;">
            ...
            <h1 style="font-size:1.125rem;font-weight:700;color:#111827;margin:0;">Add Service Type</h1>
        </div>
    </x-slot>
        ...
        <div style="background:#fff;border-radius:10px;border:1px solid #e5e7eb;padding:24px;box-shadow:0 1px 3px rgba(0,0,0,.06);">
            <form method="POST" action="{{ route('service_types.store') }}">
                ...
                <div style="margin-bottom:24px;">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required style="{{ $inp }}" placeholder="e.g. Broadband, Dedicated">

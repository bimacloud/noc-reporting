            ...
            <form method="POST" action="{{ route('backbone_links.store') }}">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
                    <div>
                        ...
                        <input type="text" name="node_a" value="{{ old('node_a') }}" required style="{{ $inp }}" placeholder="e.g. NOC-1">
                    ...
                    <div>
                        ...
                        <input type="text" name="node_b" value="{{ old('node_b') }}" required style="{{ $inp }}" placeholder="e.g. POP-Main">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin-bottom:24px;">
                    <div>
                        ...
                        <input type="text" name="provider" value="{{ old('provider') }}" style="{{ $inp }}">
                    </div>
                    <div>

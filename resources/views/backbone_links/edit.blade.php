<x-app-layout>
    ...
    <div style="max-width:640px;">
        <div x-data="{ 
            showC: {{ old('node_c', $backboneLink->node_c) ? 'true' : 'false' }},
            showD: {{ old('node_d', $backboneLink->node_d) ? 'true' : 'false' }},
            showE: {{ old('node_e', $backboneLink->node_e) ? 'true' : 'false' }}
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
                    <div>
                        ...
                        <select name="node_a" required style="{{ $inp }}">
                            ...
                            @foreach($sites as $site)
                                <option value="{{ $site->name }}" {{ old('node_a', $backboneLink->node_a) === $site->name ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="node_b" required style="{{ $inp }}">
                            ...
                            @foreach($sites as $site)
                                <option value="{{ $site->name }}" {{ old('node_b', $backboneLink->node_b) === $site->name ? 'selected' : '' }}>
                                    {{ $site->name }} ({{ $site->siteGroup->name ?? 'No Group' }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div x-show="showC" x-transition>
                        ...
                        <div style="display:flex;gap:8px;">
                            <select name="node_c" style="{{ $inp }}">
                                ...
                                @foreach($sites as $site)
                                    <option value="{{ $site->name }}" {{ old('node_c', $backboneLink->node_c) === $site->name ? 'selected' : '' }}>
                                        {{ $site->name }} ({{ $site->siteGroup->name ?? 'No Group' }})
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div x-show="showD" x-transition>
                        ...
                        <div style="display:flex;gap:8px;">
                            <select name="node_d" style="{{ $inp }}">
                                ...
                                @foreach($sites as $site)
                                    <option value="{{ $site->name }}" {{ old('node_d', $backboneLink->node_d) === $site->name ? 'selected' : '' }}>
                                        {{ $site->name }} ({{ $site->siteGroup->name ?? 'No Group' }})
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div x-show="showE" x-transition>
                        ...
                        <div style="display:flex;gap:8px;">
                            <select name="node_e" style="{{ $inp }}">
                                ...
                                @foreach($sites as $site)
                                    <option value="{{ $site->name }}" {{ old('node_e', $backboneLink->node_e) === $site->name ? 'selected' : '' }}>
                                        {{ $site->name }} ({{ $site->siteGroup->name ?? 'No Group' }})
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div>
                        ...
                        <select name="provider" style="{{ $inp }}">
                            ...
                            @foreach($providers as $prov)
                                <option value="{{ $prov->name }}" {{ old('provider', $backboneLink->provider) == $prov->name ? 'selected' : '' }}>{{ $prov->name }} ({{ $prov->type }})</option>
                            @endforeach
                        </select>
                    </div>
                    <div>

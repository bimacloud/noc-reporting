<x-app-layout>
    <x-slot name="header">
        <div style="display:flex;align-items:center;gap:10px;">
            ...
            <h1 style="font-size:1.125rem;font-weight:700;color:#111827;margin:0;">Add Customer</h1>
        </div>
    </x-slot>
        ...
        <div style="background:#fff;border-radius:10px;border:1px solid #e5e7eb;padding:24px;box-shadow:0 1px 3px rgba(0,0,0,.06);">
            <form method="POST" action="{{ route('customers.store') }}">
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <input type="date" name="registration_date" value="{{ old('registration_date') }}" style="{{ $inp }}">
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <textarea name="address" style="{{ $inp }}" rows="3" placeholder="Customer address">{{ old('address') }}</textarea>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px;margin-bottom:24px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="bandwidth" value="{{ old('bandwidth') }}" style="{{ $inp }}" placeholder="e.g. 50 Mbps">
                    </div>
                </div>
